            ...
            >
              ...
              <motion.div variants={fadeInUp} transition={easeOutExpo}>
                <div className="flex items-center gap-3">
                  <h1 className="text-3xl font-bold font-display">Commande</h1>
              ...
              {/* Estimated time */}
              <motion.div variants={fadeInUp} transition={easeOutExpo} className="flex items-center gap-2 rounded-xl bg-primary/5 p-4 text-sm">
              ...
              {/* Timeline */}
              <motion.div variants={fadeInUp} transition={easeOutExpo} className="rounded-2xl bg-card p-4 card-warm-glow">
                <h3 className="mb-4 font-display font-semibold">Suivi</h3>
                <OrderTimeline currentStatus={order.status} />
              </motion.div>

              {/* Items */}
              <motion.div variants={fadeInUp} transition={easeOutExpo} className="rounded-2xl bg-card p-4 card-warm-glow">
                <h3 className="mb-4 font-display font-semibold">Articles</h3>
                ...
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-xl font-display font-bold text-gradient-warm">{formatPrice(order.total)}</span>
                </div>
              </motion.div>
            </motion.div>
          ) : (
